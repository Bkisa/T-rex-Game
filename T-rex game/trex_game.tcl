...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins myip_0/S00_AXI] [get_bd_intf_pins smartconnect_0/M00_AXI]
  ...
  connect_bd_net -net myip_0_rgb [get_bd_pins myip_0/rgb] [get_bd_pins rgb2tmds_0/video_data]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins myip_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins myip_0/s00_axi_aresetn] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net vtg_0_hsync [get_bd_pins rgb2tmds_0/hsync] [get_bd_pins vtg_0/hsync]
  connect_bd_net -net vtg_0_pixel_x [get_bd_pins myip_0/pixel_x] [get_bd_pins vtg_0/pixel_x]
  connect_bd_net -net vtg_0_pixel_y [get_bd_pins myip_0/pixel_y] [get_bd_pins vtg_0/pixel_y]
  connect_bd_net -net vtg_0_video_active [get_bd_pins myip_0/video_active] [get_bd_pins rgb2tmds_0/video_active] [get_bd_pins vtg_0/video_active]
